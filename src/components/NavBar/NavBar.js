                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a
                                href="https://www.linkedin.com/in/thayn%C3%A1-thauany/" target="_blank" rel="noreferrer">
                                <img src={navIcon1} alt='' /></a>
                            <a href="https://www.facebook.com/thayna.thauany/" target="_blank" rel="noreferrer"><img src={navIcon2} alt='' /></a>
                            <a href="https://www.instagram.com/thathauany/" target="_blank" rel="noreferrer"><img src={navIcon3} alt='' /></a>
                        </div>
